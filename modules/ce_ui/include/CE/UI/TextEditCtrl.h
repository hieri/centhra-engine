...
namespace ce
{
	namespace ui
	{
		...
		public:
			TextEditCtrl(Vector2<short> position, Vector2<short> extent, Font *font, unsigned short maxSize, const char *text = "", Color<float> color = Color<float>(1.f, 1.f, 1.f, 1.f));
